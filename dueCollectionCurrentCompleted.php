...
$sql="SELECT * FROM new_transition WHERE transitionId IN (SELECT transitionId FROM due WHERE status = 'completed' AND dueDate = '$date' AND companyId ={$_SESSION['companyId']}) ";
