...
<li><a href="#"><span class="glyphicon glyphicon-log-in"></span> <strong><?php echo $_SESSION['empUserName']; ?></strong></a></li>
<li><a href="#"><span class="glyphicon glyphicon-log-in"></span> <strong><?php echo $_SESSION['empBranchName']; ?></strong></a></li>
