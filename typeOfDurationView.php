...
if(isset($_POST['get_option']))
{
 ...
 $find=mysqli_query($conn,"select * from type_of_duration WHERE companyId LIKE {$_SESSION['companyId']} AND branchName='$state'");
 while($row=mysqli_fetch_array($find))
 {
  echo "<option value=".$row['durationId'].">".$row['durationType']."</option>";
 }
 exit;
}
...
for($i=0; $i<sizeof($q5); $i++){
         ...
         $sql_query = "DELETE FROM type_of_duration  WHERE durationId = $q5[$i]";
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
           <div class="panel panel-info">
            ...
            <form action = "" method = "post" role="form">
                    ...
                    <label for="sel2">Mutiple select Type Of Duration</label>
